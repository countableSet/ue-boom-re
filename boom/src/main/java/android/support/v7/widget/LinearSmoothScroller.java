...
public abstract class LinearSmoothScroller extends SmoothScroller
{
    ...
    public int calculateDxToMakeVisible(final View view, int calculateDtToFit) {
        ...
        if (layoutManager == null || !layoutManager.canScrollHorizontally()) {
            ...
            calculateDtToFit = this.calculateDtToFit(layoutManager.getDecoratedLeft(view) - layoutParams.leftMargin, layoutManager.getDecoratedRight(view) + layoutParams.rightMargin, layoutManager.getPaddingLeft(), layoutManager.getWidth() - layoutManager.getPaddingRight(), calculateDtToFit);
        }
        return calculateDtToFit;
    }
    
    public int calculateDyToMakeVisible(final View view, int calculateDtToFit) {
        final LayoutManager layoutManager = ((RecyclerView.SmoothScroller)this).getLayoutManager();
        if (layoutManager == null || !layoutManager.canScrollVertically()) {
            ...
            final LayoutParams layoutParams = (LayoutParams)view.getLayoutParams();
            calculateDtToFit = this.calculateDtToFit(layoutManager.getDecoratedTop(view) - layoutParams.topMargin, layoutManager.getDecoratedBottom(view) + layoutParams.bottomMargin, layoutManager.getPaddingTop(), layoutManager.getHeight() - layoutManager.getPaddingBottom(), calculateDtToFit);
        }
        return calculateDtToFit;
    }
