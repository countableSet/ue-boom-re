        ...
        public Object getItem(final int n) {
            ...
            switch (this.getItemViewType(n)) {
                ...
                case 0: {
                    ...
                    activity = this.mDataModel.getActivity(n2);
                    break;
                }
            }
            return activity;
        ...
        public View getView(final int n, final View view, final ViewGroup viewGroup) {
            ...
            switch (this.getItemViewType(n)) {
                ...
                case 1: {
                    ...
                    view2 = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    view2.setId(1);
                    ((TextView)view2.findViewById(R.id.title)).setText((CharSequence)ActivityChooserView.this.getContext().getString(R.string.abc_activity_chooser_view_see_all));
                    break;
                }
                case 0: {
                    Label_0144: {
