...
public abstract class AppCompatDelegate
{
    ...
    private static AppCompatDelegate create(final Context context, final Window window, final AppCompatCallback appCompatCallback) {
        ...
        if (sdk_INT >= 23) {
            appCompatDelegateImplV7 = new AppCompatDelegateImplV23(context, window, appCompatCallback);
        }
        else if (sdk_INT >= 14) {
            appCompatDelegateImplV7 = new AppCompatDelegateImplV14(context, window, appCompatCallback);
        }
        else if (sdk_INT >= 11) {
            appCompatDelegateImplV7 = new AppCompatDelegateImplV11(context, window, appCompatCallback);
        }
        else {
            appCompatDelegateImplV7 = new AppCompatDelegateImplV7(context, window, appCompatCallback);
        }
