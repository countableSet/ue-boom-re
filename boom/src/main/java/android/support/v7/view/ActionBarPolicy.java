...
public class ActionBarPolicy
{
    ...
    public boolean hasEmbeddedTabs() {
        ...
        if (this.mContext.getApplicationInfo().targetSdkVersion >= 16) {
            b = this.mContext.getResources().getBoolean(R.bool.abc_action_bar_embed_tabs);
        }
        else {
            b = this.mContext.getResources().getBoolean(R.bool.abc_action_bar_embed_tabs_pre_jb);
        }
        return b;
    }
