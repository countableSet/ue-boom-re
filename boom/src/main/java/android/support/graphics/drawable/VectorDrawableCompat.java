...
public class VectorDrawableCompat extends VectorDrawableCommon
{
    ...
    private void inflateInternal(final Resources resources, final XmlPullParser xmlPullParser, final AttributeSet set, final Resources$Theme resources$Theme) throws XmlPullParserException, IOException {
        ...
        int n2;
        for (int i = xmlPullParser.getEventType(); i != 1; i = xmlPullParser.next(), n = n2) {
            if (i == 2) {
    ...
    private static PorterDuff$Mode parseTintModeCompat(final int n, final PorterDuff$Mode porterDuff$Mode) {
        ...
        switch (n) {
            ...
            case 16: {
                porterDuff$Mode2 = PorterDuff$Mode.ADD;
                return porterDuff$Mode2;
            }
            case 15: {
    ...
    PorterDuffColorFilter updateTintFilter(PorterDuffColorFilter porterDuffColorFilter, final ColorStateList list, final PorterDuff$Mode porterDuff$Mode) {
