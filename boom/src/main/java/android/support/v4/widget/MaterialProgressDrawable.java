...
class MaterialProgressDrawable extends Drawable implements Animatable
{
    ...
    private int evaluateColorChange(final float n, int i, int intValue) {
        ...
        final int n2 = intValue2 >> 24 & 0xFF;
        i = (intValue2 >> 16 & 0xFF);
        final int n3 = intValue2 >> 8 & 0xFF;
        final int n4 = intValue2 & 0xFF;
        intValue = intValue;
        return (int)(((intValue >> 24 & 0xFF) - n2) * n) + n2 << 24 | (int)(((intValue >> 16 & 0xFF) - i) * n) + i << 16 | (int)(((intValue >> 8 & 0xFF) - n3) * n) + n3 << 8 | (int)(((intValue & 0xFF) - n4) * n) + n4;
    }
