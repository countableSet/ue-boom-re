...
public class ActivityOptionsCompat
{
    ...
    public static ActivityOptionsCompat makeSceneTransitionAnimation(final Activity activity, final Pair<View, String>... array) {
        ...
        if (Build$VERSION.SDK_INT >= 21) {
            ...
            if (Build$VERSION.SDK_INT >= 24) {
                activityOptionsCompat = new ActivityOptionsImpl24(ActivityOptionsCompat24.makeSceneTransitionAnimation(activity, array2, array3));
            }
            else if (Build$VERSION.SDK_INT >= 23) {
                activityOptionsCompat = new ActivityOptionsImpl23(ActivityOptionsCompat23.makeSceneTransitionAnimation(activity, array2, array3));
            }
            else {
                activityOptionsCompat = new ActivityOptionsImpl21(ActivityOptionsCompat21.makeSceneTransitionAnimation(activity, array2, array3));
            }
        }
        else {
            activityOptionsCompat = new ActivityOptionsCompat();
