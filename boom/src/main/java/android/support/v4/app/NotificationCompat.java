...
public class NotificationCompat
{
    ...
    static Notification[] getNotificationArrayFromBundle(final Bundle bundle, final String s) {
        ...
        if (parcelableArray instanceof Notification[] || parcelableArray == null) {
            ...
            final Notification[] array2 = new Notification[((Notification[])parcelableArray).length];
            for (int i = 0; i < ((Notification[])parcelableArray).length; ++i) {
                array2[i] = (Notification)parcelableArray[i];
            }
            ...
            static Message getMessageFromBundle(final Bundle bundle) {
                try {
                    ...
                    if (!bundle.containsKey("text") || !bundle.containsKey("time")) {
                        ...
                        final Message message2 = message = new Message(bundle.getCharSequence("text"), bundle.getLong("time"), bundle.getCharSequence("sender"));
