    ...
    public static <T> boolean equalsSetHelper(final Set<T> set, final Object o) {
        ...
        if (set == o) {
            ...
            if (o instanceof Set) {
                ...
                try {
                    b3 = (set.size() == set2.size() && set.containsAll(set2) && b);
                }
    ...
    final class MapIterator implements Iterator<Entry<K, V>>, Entry<K, V>
    {
        ...
        public final boolean equals(final Object o) {
            ...
            if (o instanceof Entry) {
                ...
                b2 = (ContainerHelpers.equal(entry.getKey(), MapCollections.this.colGetEntry(this.mIndex, 0)) && ContainerHelpers.equal(entry.getValue(), MapCollections.this.colGetEntry(this.mIndex, 1)) && b);
            }
            return b2;
        }
