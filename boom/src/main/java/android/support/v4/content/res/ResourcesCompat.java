...
public final class ResourcesCompat
{
    ...
    @ColorInt
    public static int getColor(@NonNull final Resources resources, @ColorRes int n, @Nullable final Resources$Theme resources$Theme) throws Resources$NotFoundException {
        if (Build$VERSION.SDK_INT >= 23) {
            n = ResourcesCompatApi23.getColor(resources, n, resources$Theme);
        }
        else {
