...
public final class MenuItemCompat
{
    ...
    public static MenuItem setActionView(MenuItem menuItem, final int actionView) {
        if (menuItem instanceof SupportMenuItem) {
            menuItem = ((SupportMenuItem)menuItem).setActionView(actionView);
        }
        else {
            menuItem = MenuItemCompat.IMPL.setActionView(menuItem, actionView);
        }
        return menuItem;
    }
    
    public static MenuItem setActionView(MenuItem menuItem, final View actionView) {
        if (menuItem instanceof SupportMenuItem) {
            menuItem = ((SupportMenuItem)menuItem).setActionView(actionView);
        }
        else {
    ...
    public static MenuItem setOnActionExpandListener(MenuItem menuItem, final OnActionExpandListener supportOnActionExpandListener) {
        if (menuItem instanceof SupportMenuItem) {
            menuItem = (MenuItem)((SupportMenuItem)menuItem).setSupportOnActionExpandListener(supportOnActionExpandListener);
        }
        else {
            menuItem = MenuItemCompat.IMPL.setOnActionExpandListener(menuItem, supportOnActionExpandListener);
        }
        return menuItem;
    }
    ...
    static class IcsMenuVersionImpl extends HoneycombMenuVersionImpl
    {
        ...
        public MenuItem setOnActionExpandListener(MenuItem menuItem, final OnActionExpandListener onActionExpandListener) {
            if (onActionExpandListener == null) {
                ...
                menuItem = MenuItemCompatIcs.setOnActionExpandListener(menuItem, (MenuItemCompatIcs.SupportActionExpandProxy)new MenuItemCompatIcs.SupportActionExpandProxy() {
                    @Override
