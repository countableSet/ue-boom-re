...
public class MenuMainFragment$$ViewBinder<T extends MenuMainFragment> implements ViewBinder<T>
{
    public void bind(final Finder finder, final T t, final Object o) {
        final View view = finder.findRequiredView(o, 16908298, "field 'mListView' and method 'onItemClicked'");
