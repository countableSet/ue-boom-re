...
class ElementListUnionParameter extends TemplateParameter
{
    ...
    public ElementListUnionParameter(final Constructor constructor, final ElementListUnion elementListUnion, final ElementList list, final Format format, final int index) throws Exception {
        this.contact = new Contact(list, constructor, index);
        this.label = new ElementListUnionLabel(this.contact, elementListUnion, list, format);
